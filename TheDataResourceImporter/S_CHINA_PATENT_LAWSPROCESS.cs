...
namespace TheDataResourceImporter
{
    ...
    public partial class S_CHINA_PATENT_LAWSPROCESS
    {
        ...
        public string APPROVAL_DATE_STR { get; set; }
        public string DATE_ISSUED_STR { get; set; }
        public string IMPLEMENTATION_DATE_STR { get; set; }
        public string SIGN_DATE_STR { get; set; }
